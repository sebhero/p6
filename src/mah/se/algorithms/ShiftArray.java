...
public class ShiftArray{
	/**
	 *Shifts the array one step to the right
	 *@param model, array7
	 *@return array
	 **/
	public Array7 shiftLeft(Array7x7 model, Array7 array7){
		Array7 array = new Array7();
		array = model.getCol(0);//array gets the values of the first column
		...
		model.setCol(6, array7); // last column of model gets the value from array7 in param
